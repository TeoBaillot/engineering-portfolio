...
*/
  ...
  Conv2_12x12x20_5x5x40_1_0(pool1_output, conv2_bias, conv2_output);
...
*/
  ...
  Fc1_40_400(pool2_output, fc1_bias, fc1_output);
/*  printf("\n\nFc1 output[0..%d]: \n", FC1_NBOUTPUT-1);
...
//  char* 	output_filename = 		"output.pgm"; 
  ...
  unsigned long long xilinx_start=0;
  unsigned long long xilinx_end=0;
  unsigned long long xilinx_time=0;
  unsigned long long xilinx_time_max =0;
  unsigned long long xilinx_time_min=0;
  unsigned long long xilinx_time_avg=0;
